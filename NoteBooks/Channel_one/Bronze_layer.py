...
JSON_FILE = "Channel_one_live_data.json"
JSON_PATH = os.path.join(JSON_DIR, JSON_FILE)
CHANNEL_ID = "UCPP3etACgdUWvizcES1dJ8Q"

FETCH_INTERVAL = 900   # Fetch every 30 sec
RUN_DURATION = 3600     # Run for 2 min (you can change to 3600 for 1 hour)
...
# MAGIC %fs ls /Volumes/youtub_data_catalog/youtube_data_house/soure_file
