...
# creating variable
base_path = "dbfs:/Volumes/youtub_data_catalog/youtube_data_house/soure_file/Channel_two_live_data.json"

save_path = "dbfs:/Volumes/youtub_data_catalog/youtube_data_house/soure_file/silver_dataclean_layer_2"
